    ...
    <div class="layui-form layui-form-pane">
      <div class="layui-tab layui-tab-brief" lay-filter="user">
        <ul class="layui-tab-title">
          <li><a href="add2.jsp">支出</a></li>
          <li class="layui-this">收入</li>
        </ul>
        <div class="layui-form layui-tab-content" id="shouru" style="padding: 20px 0;">
           <div class="layui-tab-item layui-show">
            <form action="add" method="post">
              ...
              <div class="layui-row layui-col-space15 layui-form-item">
                ...
                <div class="layui-col-md3">
                  <label for="addTime" class="layui-form-label">发生日期</label>
                  <div class="layui-input-block">
                    <input  type="text" name="addTime" class="layui-input" id="test5" placeholder="yyyy-MM-dd HH:mm:ss">
                  </div>
                </div>
              </div>
